 ...
 */
public class TelaAttPaciente extends javax.swing.JFrame {

    /**
     * Creates new form TelaSecretaria
     */
    public TelaAttPaciente(Vopaciente paciente) {
        initComponents();
        cmpNome.setText(paciente.getNome());
        cmpRG.setText(paciente.getRg());
        cmpCPF.setText(paciente.getCpf());
        dcDataNasc.setDate(paciente.getDataNascimento());
        cmpTelefone.setText(paciente.getTelefone());
        cmpCelular.setText(paciente.getCelular());
        cmpEndereco.setText(paciente.getEndereco());
        cmpEmail.setText(paciente.getEmail());
        if (paciente.getTipoConvenio().equals("Plano de Saude")){
            cbTipoConvenio.setSelectedIndex(1);
        }else{
            cbTipoConvenio.setSelectedIndex(0);
        }
        String id = String.valueOf(paciente.getIdPessoa());
        cmpID.setText(id);
    }
    ...
    private void initComponents() {
        ...
        cbTipoConvenio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Privado", "Plano de Saude" }));
        ...
        btRemoverPaciente.setText("Remover Paciente");
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        boolean resultado = COPaciente.attPaciente(id,cmpNome.getText(), cmpRG.getText(), cmpCPF.getText(), 
    ...
    private void btRemoverPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverPacienteActionPerformed
        int id = Integer.parseInt(cmpID.getText());
        int result = JOptionPane.showConfirmDialog(rootPane, "Tem Certeza que deseja remover este Paciente?");
        if(result == 0){
            CRUD_Vopacienteext.excluir(CRUD_Vopacienteext.buscarPaciente(id));
            boolean resultado = COPaciente.excluiPaciente(id);
            if(resultado){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAttPaciente(new Vopaciente()).setVisible(true);
            }
        }); 
    }
