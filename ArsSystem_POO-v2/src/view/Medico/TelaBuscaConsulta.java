...
public class TelaBuscaConsulta extends javax.swing.JFrame {
    ...
    private void btSelecionaConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecionaConsultaActionPerformed
        ...
        if(indiceLinha != -1){
            ...
            TelaAddProntuario NovaTelaAddProntuario = new TelaAddProntuario(selectedConsulta.getVoconsultasId());
            NovaTelaAddProntuario.setLocationRelativeTo(null);
            NovaTelaAddProntuario.setVisible(true);
            this.dispose();
        }else{
