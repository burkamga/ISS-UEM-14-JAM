...
public class TelaAttSecretaria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btExcluirSecretaria = new javax.swing.JButton();
        ...
        btExcluirSecretaria.setText("Excluir Secretária");
        btExcluirSecretaria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btExcluirSecretariaActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(AdicionaPacienteLayout.createSequentialGroup()
                        .addGroup(AdicionaPacienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(AdicionaPacienteLayout.createSequentialGroup()
                                ...
                                .addGap(101, 101, 101)
                                .addComponent(btExcluirSecretaria)
                                .addGap(57, 57, 57))
    ...
    private void btExcluirSecretariaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirSecretariaActionPerformed
        int id = Integer.parseInt(cmpID.getText());
        int result = JOptionPane.showConfirmDialog(rootPane, "Tem Certeza que deseja remover esta secretária?");
        if(result == 0){
            boolean resultado = COSecretaria.excluiSecretaria(id);
            if(resultado){
                TelaAdm voltaTela = new TelaAdm();
                voltaTela.setLocationRelativeTo(null);
                voltaTela.setVisible(true);
    ...
    }//GEN-LAST:event_btExcluirSecretariaActionPerformed
    ...
    private javax.swing.JButton btExcluirSecretaria;
